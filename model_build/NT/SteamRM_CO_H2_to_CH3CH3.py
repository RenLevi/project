...
reactions = ReactionLibUtils.merge_reactions([
    ...
    C2OneReactionOneProductReactionLib.reaction_add_carbon_species_on_1st_carbon,
    C2OneReactionOneProductReactionLib.reaction_add_H_on_carbons,
    C2OneReactionOneProductReactionLib.reaction_add_H_on_the_Os,
    C2OneReactionOneProductReactionLib.reaction_add_OH_on_carbons,
    C2OneReactionOneProductReactionLib.reaction_add_O_single_bond_on_carbons,
    C2OneReactionOneProductReactionLib.reaction_remove_H_on_Os,
    C2OneReactionOneProductReactionLib.reaction_remove_H_on_carbons,
    C2OneReactionOneProductReactionLib.reaction_remove_first_O_or_OH_on_carbons,
    C2OneReactionOneProductReactionLib.reaction_remove_second_O_or_OH_on_carbon
...
CH3CH2OH = SpeciesNode(Chem.AddHs(Chem.MolFromSmiles('CCO')))# 'AddHs' will fill H，eg. C+4H==CH4
CO2 = SpeciesNode(Chem.MolFromSmiles('OCO'))
...
ng = NetworkGenerator(
    initial_reactants=[CO2],
    final_results=[CH3CH2OH],
    valid_mol_check_func_list=check_func)


ng.species_do_one_reactant_one_product_reaction_until_no_new_product(reactions)
